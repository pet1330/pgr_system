...
@section('page_title', 'Create New Staff')
        ...
        <form action="{{ route('staff.store') }}" method="POST">
          ...
          <div class="row">
            ...
            <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }} col-md-4">
              ...
              <input type="text" class="form-control" placeholder="Name" name="university_email" value="{{ $university_id ? $university_id."@lincoln.ac.uk" : old('university_email') }}">
