                    ...
                    <table class="table user-profile">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ Auth::user()->tier_four ? 'Yes' : 'No' }}</td>
                            </tr>
                            <tr>
                                <td>Funding type</td>
                                <td>{{ Auth::user()->record()->fundingType->name }} funded</td>
                            </tr>
                            <tr>
                                <td>Programme</td>
                                <td>{{ ucfirst(Auth::user()->record()->programme->name) }}</td>
                            </tr>
                            <tr>
                                <td>Mode of study</td>
                                <td>{{ Auth::user()->modeOfStudy->name }}</td>
                            </tr>
                            <tr>
                                <td>Enrolment status</td>
                                <td>
                                    {{ Auth::user()->enrolmentStatus->status }}
                                </td>
                            </tr>
                        </tbody>
                    </table>
